...
`24.05-24.08` **MDL 대학ERP(PoC / Agent)**
...
. 2025.03-25.06 목표로 후속 과제 진행 중<br/><br/>

`24.04-24.11` **신한투자증권(본과제 / Q&A)**
...
`2023-04-19`
**전자신문인터넷 [챗GPT 등 생성AI를 활용한서비스 사례 분석 및 전망](https://conference.etnews.com/conf_info.html?uid=246)**, *생성AI 기술과 챗봇의 미래*.

`2014-03-27`
**한국미래기술교육연구원 차세대 스마트 센서 융합 기술 세미나**, *웨어러블 환경에서의 모션 인식: 모션센서 기반의 웨어러블 제어 기술*.

`2013-10-17`
**eBiz 연구회 정기 세미나**, *모션인식 2.0*.

`2013-09-27`
**K모바일 웨어러블 컴퓨터 비즈니스 레볼루션 2014**, *웨어러블 시대의 킬러앱은?: 웨어러블 컴퓨터 서비스 시나리오*.

`2023-07-16`
**ETRI 사내 세미나**, *모션인식 2.0: 키넥트 이후의 모션인식 기술*.

`2023-07-11`
**K모바일 코리아 네추럴UI/UX 세미나**, *모션인식 2.0: 키넥트 이후의 모션인식 기술* (SlideShare 2014년도 상위 5% 열람 기록).

`2011-06-24`
**삼성SDS 사내 세미나**, *Gesture Interface 기술 동향 및 전망*.

`2011-01-28`
**K모바일 코리아 모바일 UX 컨퍼런스**, *모션 인식 인터페이스 기술 동향과 전망*.
